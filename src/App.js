    ...
    <div className="min-h-screen bg-[#0a0a0f] text-white flex flex-col">
      <div className="max-w-md mx-auto w-full flex-1 p-4">
        <header className="flex justify-between items-center mb-4">
          <div><h1 className="text-2xl font-bold">Crick<span className="text-[#FF7A00]">Clash</span></h1><p className="text-white font-bold ">Ꭺ</p></div>
                ...
                <div className="mt-6 space-y-3">
                  ...
                  {debates.slice(0,5).map(d => (
                    <div key={d.id} className="bg-[#13131a] p-3 rounded-xl">
                      ...
                      {replyingTo === d.id && (<div className="mt-2 flex gap-2"><input value={replyText} onChange={e=>setReplyText(e.target.value)} className="flex-1 bg-black p-2 rounded text-sm" placeholder="Reply..." /><button onClick={()=>submitComment(d.id)} className="bg-[#a8ff00] text-black px-4 py-2 rounded-lg font-bold">Send</button>
