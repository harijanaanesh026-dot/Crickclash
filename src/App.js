...
const ALL_PLAYERS = [
  // BATTERS
  { name: 'Virat Kohli', role: 'BATTER', votes: 0 }, { name: 'Sachin Tendulkar', role: 'BATTER', votes: 0 },
  { name: 'Rohit Sharma', role: 'BATTER', votes: 0 }, { name: 'Shubman Gill', role: 'BATTER', votes: 0 },
  { name: 'Suryakumar Yadav', role: 'BATTER', votes: 0 }, { name: 'Tilak Varma', role: 'BATTER', votes: 0 },
  { name: 'Rahul Dravid', role: 'BATTER', votes: 0 }, { name: 'Virendra Sehwag', role: 'BATTER', votes: 0 },
  { name: 'Abhishek Sharma', role: 'BATTER', votes: 0 }, { name: 'Vaibhav Suryavanshi', role: 'BATTER', votes: 0 },
  { name: 'Yashasvi Jaiswal', role: 'BATTER', votes: 0 }, { name: 'KL Rahul', role: 'BATTER', votes: 0 },
  { name: 'Sunil Gavaskar', role: 'BATTER', votes: 0 }, { name: 'VVS Laxman', role: 'BATTER', votes: 0 },
  { name: 'Yuvaraj Singh', role: 'BATTER', votes: 0 }, { name: 'Priyansh Arya', role: 'BATTER', votes: 0 },
  { name: 'Sai Sudarshan', role: 'BATTER', votes: 0 }, { name: 'Devdut Padikal', role: 'BATTER', votes: 0 },
  { name: 'Rinku Singh', role: 'BATTER', votes: 0 }, { name: 'Ruturaj Gaikwad', role: 'BATTER', votes: 0 },

  // BOWLERS
  { name: 'Jasprit Bumrah', role: 'BOWLER', votes: 0 }, { name: 'Bhuvaneswar Kumar', role: 'BOWLER', votes: 0 },
  { name: 'Mahammed Shami', role: 'BOWLER', votes: 0 }, { name: 'Mahammed Siraj', role: 'BOWLER', votes: 0 },
  { name: 'Prasidh Krishna', role: 'BOWLER', votes: 0 }, { name: 'Kuldeep Yadav', role: 'BOWLER', votes: 0 },
  { name: 'Ishant Sharma', role: 'BOWLER', votes: 0 }, { name: 'Umesh Yadav', role: 'BOWLER', votes: 0 },
  { name: 'Harbhajan Singh', role: 'BOWLER', votes: 0 }, { name: 'Yuzvendra Chahal', role: 'BOWLER', votes: 0 },
  { name: 'Harshal Patel', role: 'BOWLER', votes: 0 },

  // ALL-ROUNDERS
  { name: 'Hardik Pandya', role: 'ALL-ROUNDER', votes: 0 }, { name: 'Krunal Pandya', role: 'ALL-ROUNDER', votes: 0 },
  { name: 'Nitish Reddy', role: 'ALL-ROUNDER', votes: 0 }, { name: 'Kapil Dev', role: 'ALL-ROUNDER', votes: 0 },
  { name: 'Ravindra Jadeja', role: 'ALL-ROUNDER', votes: 0 }, { name: 'Ravichandran Ashwin', role: 'ALL-ROUNDER', votes: 0 },
  { name: 'Anil kumble', role: 'ALL-ROUNDER', votes: 0 }, { name: 'Shivam Dube', role: 'ALL-ROUNDER', votes: 0 },
  { name: 'Axar Patel', role: 'ALL-ROUNDER', votes: 0 },

  // KEEPERS
  { name: 'MS Dhoni', role: 'KEEPER', votes: 0 }, { name: 'Rishabh Pant', role: 'KEEPER', votes: 0 },
  { name: 'Ishan Kishan', role: 'KEEPER', votes: 0 }, { name: 'Dinesh Karthik', role: 'KEEPER', votes: 0 },
  { name: 'Prabhsimran Singh', role: 'KEEPER', votes: 0 }, { name: 'Sanju Samson', role: 'KEEPER', votes: 0 },
  ...
  { name: 'Rahul Dravid', role: 'CAPTAIN', votes: 0 }, { name: 'Kapil Dev', role: 'CAPTAIN', votes: 0 },
  { name: 'Hardik Pandya', role: 'CAPTAIN', votes: 0 }, { name: 'KL Rahul', role: 'CAPTAIN', votes: 0 },
  { name: 'Rishabh Pant', role: 'CAPTAIN', votes: 0 }, { name: 'Shubman Gill', role: 'CAPTAIN', votes: 0 },
